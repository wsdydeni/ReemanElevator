...
public class LiftsSelectAdapter extends RecyclerView.Adapter<LiftsSelectAdapter.BuildingSelectViewHolder> {

    private final List<Lifts> dataList = new ArrayList<>();

    public void setDataList(List<Lifts> newList) {
        this.dataList.clear();
    ...
    public void onBindViewHolder(@NonNull BuildingSelectViewHolder holder, int position) {
        holder.textView.setText(dataList.get(position).getLift_name());
